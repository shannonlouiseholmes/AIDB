...
public class GuestBookWebController
{
    ...
    public String saveComment (Model model, @PathVariable Integer id, @ModelAttribute (NEW_ENTRY_TEMPLATE_ID) GuestBookEntry newEntry, BindingResult bindingResult)
    {
        if(!bindingResult.hasErrors ())
        {
